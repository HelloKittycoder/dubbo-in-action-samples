...
import com.kittycoder.dubbo.samples.echo.refer.EchoConsumer;
...
public class AnnotationConsumer {
    ...
    @Configuration
    // #3 指定要扫描的消费注解，会触发注入
    @EnableDubbo(scanBasePackages = "com.kittycoder.dubbo.samples.echo")
    @ComponentScan(value = {"com.kittycoder.dubbo.samples.echo"})
